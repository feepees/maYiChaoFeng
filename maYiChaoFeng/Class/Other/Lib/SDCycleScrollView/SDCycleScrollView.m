...
//    _currentPageDotColor =[UIColor colorWithRed:1.00f green:0.38f blue:0.00f alpha:1.00f];
    _pageDotColor = [UIColor whiteColor];
    
    _currentPageDotColor  = [UIColor colorWithPatternImage:[UIImage imageNamed:@"page"]];
...
//    mainView.backgroundColor = [UIColor colorWithHexString:@"f5f5f5"];
...
//        [self insertSubview:bgImageView belowSubview:self.mainView];
        [self insertSubview:bgImageView aboveSubview:self.mainView];
...
//            [cell.button sd_setImageWithURL:[NSURL URLWithString:imagePath]  forState:UIControlStateNormal placeholderImage:self.placeholderImage];
...
//        cell.imageView.backgroundColor = [UIColor colorWithHexString:@"f5f5f5"];
